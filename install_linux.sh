...
sudo install -D -m 0700 -o root sbin/settings.linux /etc/systemd/system/networkd-resolver/sbin/settings
sudo install -D -m 0700 -o root conf/* /etc/systemd/system/networkd-resolver/conf/

sudo install -D -m 0700 -o root systemd/networkd-resolver.service /etc/systemd/system/
